...
int main(int argc, char *argv[])
{
	...
	optParser.add_long_opt("rtmpUrl", &options.rtmpUrl,
						   "The rtmp cdn url");
	...
	// Create Agora Rtmp connection

	agora::rtc::RtmpConnectionConfiguration ccfg;
	ccfg.videoConfig.height = options.video.height;
	ccfg.videoConfig.width = options.video.width;
