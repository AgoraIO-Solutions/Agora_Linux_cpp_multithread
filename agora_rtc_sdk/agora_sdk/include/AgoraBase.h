...
enum COMPRESSION_PREFERENCE {
  /**
   * (Default) Low latency is preferred, usually used in real-time communication where low latency
   * is the number one priority.
   */
  PREFER_LOW_LATENCY,
  /**
   * Prefer quality in sacrifice of a degree of latency, usually around 30ms ~ 150ms, depends target
   * fps
   */
  PREFER_QUALITY,
};
...
struct WatermarkTimestamp{
  ...
  int fontSize;
  /**
   * The path of the font file for the timestamp. The default value is NULL, which means the system
   */
...
/**
 * The definition of the WatermarkLitera struct.
 */
struct WatermarkLitera {
  /**
   * The litera content of the watermark. The default value is NULL.
   */
  const char* wmLitera;
  /**
   * The path of the font file for the litera. The default value is NULL, which means the system
   */
  const char* fontFilePath;
  /**
   * The font size of the litera. The default value is 10.
   */
  int fontSize;
...
/**
 * The definition of the WatermarkConfig struct.
 */
struct WatermarkConfig {
  /**
   * The watermark index. The default value is 0.
   */
  int index;
  /**
   * The watermark source type. See WatermarkSourceType.
   */
  ...
  /**
   * The watermark litera. See WatermarkLitera.
   */
