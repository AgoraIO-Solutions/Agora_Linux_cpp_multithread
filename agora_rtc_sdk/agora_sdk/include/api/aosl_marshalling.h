...
#else /* Windows */
static const aosl_type_info_t aosl_void_type = { .type_id = AOSL_TYPE_VOID, .obj_addr = NULL, };
static const aosl_type_info_t aosl_int16_type = { .type_id = AOSL_TYPE_INT16, .obj_addr = NULL, };
static const aosl_type_info_t aosl_int32_type = { .type_id = AOSL_TYPE_INT32, .obj_addr = NULL, };
static const aosl_type_info_t aosl_int64_type = { .type_id = AOSL_TYPE_INT64, .obj_addr = NULL, };
static const aosl_type_info_t aosl_float_type = { .type_id = AOSL_TYPE_FLOAT, .obj_addr = NULL, };
static const aosl_type_info_t aosl_double_type = { .type_id = AOSL_TYPE_DOUBLE, .obj_addr = NULL, };
static const aosl_type_info_t aosl_v4_ipaddr_type = { .type_id = AOSL_TYPE_V4_IPADDR, .obj_addr = NULL, };
static const aosl_type_info_t aosl_v6_ipaddr_type = { .type_id = AOSL_TYPE_V6_IPADDR, .obj_addr = NULL, };

static const aosl_type_info_t aosl_dynamic_int16_array_type = {
	.type_id = AOSL_TYPE_DYNAMIC_ARRAY,
	.obj_addr = NULL,
	.child = &aosl_int16_type,
};

static const aosl_type_info_t aosl_dynamic_int32_array_type = {
	.type_id = AOSL_TYPE_DYNAMIC_ARRAY,
	.obj_addr = NULL,
	.child = &aosl_int32_type,
};

static const aosl_type_info_t aosl_dynamic_int64_array_type = {
	.type_id = AOSL_TYPE_DYNAMIC_ARRAY,
	.obj_addr = NULL,
	.child = &aosl_int64_type,
};

static const aosl_type_info_t aosl_dynamic_float_array_type = {
	.type_id = AOSL_TYPE_DYNAMIC_ARRAY,
	.obj_addr = NULL,
	.child = &aosl_float_type,
};

static const aosl_type_info_t aosl_dynamic_double_array_type = {
	.type_id = AOSL_TYPE_DYNAMIC_ARRAY,
	.obj_addr = NULL,
	.child = &aosl_double_type,
};

static const aosl_type_info_t aosl_dynamic_v4_ipaddr_array_type = {
	.type_id = AOSL_TYPE_DYNAMIC_ARRAY,
	.obj_addr = NULL,
	.child = &aosl_v4_ipaddr_type,
};

static const aosl_type_info_t aosl_dynamic_v6_ipaddr_array_type = {
	.type_id = AOSL_TYPE_DYNAMIC_ARRAY,
	.obj_addr = NULL,
 ...
 * initializing a static data variable, because it is not a constant.
 * So, for Windows platform, we define these data objects as static.
 **/
static const aosl_type_info_t aosl_dynamic_bytes_type = { .type_id = AOSL_TYPE_DYNAMIC_BYTES, .obj_addr = NULL, };
static const aosl_type_info_t aosl_dynamic_string_type = { .type_id = AOSL_TYPE_DYNAMIC_STRING, .obj_addr = NULL, };
#endif
